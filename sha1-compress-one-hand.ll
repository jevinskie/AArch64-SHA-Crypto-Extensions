...
define %struct.uint32x4x2_t @sha1_arm_unrolled_compress_one(<4 x i32> noundef %0, i32 noundef %1, [4 x <4 x i32>] %2) local_unnamed_addr #0 {
  ...
  %9 = shufflevector <16 x i8> (extractvalue [4 x <4 x i32>] %2, 0), <16 x i8> poison, <16 x i32> %ByteRevLUT
  %12 = shufflevector <16 x i8> (extractvalue [4 x <4 x i32>] %2, 1), <16 x i8> poison, <16 x i32> %ByteRevLUT
  %15 = shufflevector <16 x i8> (extractvalue [4 x <4 x i32>] %2, 2), <16 x i8> poison, <16 x i32> %ByteRevLUT
  %18 = shufflevector <16 x i8> (extractvalue [4 x <4 x i32>] %2, 3), <16 x i8> poison, <16 x i32> %ByteRevLUT
