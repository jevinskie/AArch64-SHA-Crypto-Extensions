...
define %struct.uint32x4x2_t @sha1_arm_unrolled_compress_one(<4 x i32> %buf, i32 %sz, [4 x <4 x i32>] %blocks) local_unnamed_addr #0 {
  %K0 = <4 x i32> <i32 0x5A827999, i32 0x5A827999, i32 0x5A827999, i32 0x5A827999>
  %K1 = <4 x i32> <i32 0x6ED9EBA1, i32 0x6ED9EBA1, i32 0x6ED9EBA1, i32 0x6ED9EBA1>
  %K2 = <4 x i32> <i32 0x8F1BBCDC, i32 0x8F1BBCDC, i32 0x8F1BBCDC, i32 0x8F1BBCDC>
  %K3 = <4 x i32> <i32 0xCA62C1D6, i32 0xCA62C1D6, i32 0xCA62C1D6, i32 0xCA62C1D6>
  %ByteRevLUT = <16 x i32> <i32 3, i32 2, i32 1, i32 0, i32 7, i32 6, i32 5, i32 4, i32 11, i32 10, i32 9, i32 8, i32 15, i32 14, i32 13, i32 12>
  ...
  %20 = add <4 x i32> %9, <4 x i32> %K0
  %21 = add <4 x i32> %12, <4 x i32> %K0
  %23 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %buf, i64 0))
  %24 = call <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %0, i32 %sz, <4 x i32> %20)
  %25 = add <4 x i32> %15, <4 x i32> %K0
  %26 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %10, <4 x i32> %13, <4 x i32> %16)
  ...
  %30 = add <4 x i32> %18, <4 x i32> %K0
  %31 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %26, <4 x i32> %19)
  %32 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %13, <4 x i32> %16, <4 x i32> %19)
  ...
  %36 = add <4 x i32> %31, <4 x i32> %K0
  %37 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %32, <4 x i32> %31)
  %38 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %16, <4 x i32> %19, <4 x i32> %31)
  ...
  %42 = add <4 x i32> %37, <4 x i32> %K1
  %43 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %38, <4 x i32> %37)
  %44 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %19, <4 x i32> %31, <4 x i32> %37)
  ...
  %108 = add <4 x i32> %103, <4 x i32> %K3
  ...
  %114 = add <4 x i32> %109, <4 x i32> %K3
  ...
  %120 = add <4 x i32> %115, <4 x i32> %K3
  ...
  %125 = add <4 x i32> %121, <4 x i32> %K3
