...
define %struct.uint32x4x2_t @sha1_arm_unrolled_compress_one(<4 x i32> noundef %0, i32 noundef %1, [4 x <4 x i32>] %2) local_unnamed_addr #0 {
  ...
  %5 = extractvalue [4 x <4 x i32>] %2, 1
  %6 = extractvalue [4 x <4 x i32>] %2, 2
  %7 = extractvalue [4 x <4 x i32>] %2, 3
  %8 = bitcast <4 x i32> %4 to <16 x i8>
  ...
  %11 = bitcast <4 x i32> %5 to <16 x i8>
  ...
  %14 = bitcast <4 x i32> %6 to <16 x i8>
  ...
  %17 = bitcast <4 x i32> %7 to <16 x i8>
  ...
  %20 = add <4 x i32> %10, <i32 1518500249, i32 1518500249, i32 1518500249, i32 1518500249>
  %21 = add <4 x i32> %13, <i32 1518500249, i32 1518500249, i32 1518500249, i32 1518500249>
  %22 = extractelement <4 x i32> %0, i64 0
  %23 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %22)
  %24 = tail call noundef <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %0, i32 %1, <4 x i32> %20)
  %25 = add <4 x i32> %16, <i32 1518500249, i32 1518500249, i32 1518500249, i32 1518500249>
  %26 = tail call noundef <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %10, <4 x i32> %13, <4 x i32> %16)
  %27 = extractelement <4 x i32> %24, i64 0
  %28 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %27)
  %29 = tail call noundef <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %24, i32 %23, <4 x i32> %21)
  %30 = add <4 x i32> %19, <i32 1518500249, i32 1518500249, i32 1518500249, i32 1518500249>
  ...
  %33 = extractelement <4 x i32> %29, i64 0
  %34 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %33)
  ...
  %40 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %39)
  ...
  %46 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %45)
  ...
  %51 = extractelement <4 x i32> %47, i64 0
  %52 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %51)
  ...
  %57 = extractelement <4 x i32> %53, i64 0
  %58 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %57)
  ...
  %63 = extractelement <4 x i32> %59, i64 0
  %64 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %63)
  ...
  %70 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %69)
  ...
  %75 = extractelement <4 x i32> %71, i64 0
  %76 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %75)
  ...
  %81 = extractelement <4 x i32> %77, i64 0
  %82 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %81)
  ...
  %87 = extractelement <4 x i32> %83, i64 0
  %88 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %87)
  ...
  %93 = extractelement <4 x i32> %89, i64 0
  %94 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %93)
  ...
  %99 = extractelement <4 x i32> %95, i64 0
  %100 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %99)
  ...
  %105 = extractelement <4 x i32> %101, i64 0
  %106 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %105)
  ...
  %111 = extractelement <4 x i32> %107, i64 0
  %112 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %111)
  ...
  %117 = extractelement <4 x i32> %113, i64 0
  %118 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %117)
  ...
  %122 = extractelement <4 x i32> %119, i64 0
  %123 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %122)
  ...
  %126 = extractelement <4 x i32> %124, i64 0
  %127 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %126)
  ...
  %130 = tail call noundef i32 @llvm.aarch64.crypto.sha1h(i32 %129)
