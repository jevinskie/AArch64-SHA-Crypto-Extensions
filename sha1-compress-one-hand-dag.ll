...
define %struct.uint32x4x2_t @sha1_arm_unrolled_compress_one(<4 x i32> %buf, i32 %sz, [4 x <4 x i32>] %blocks) local_unnamed_addr #0 {
  ...
  %vadd_0 = vadd <4 x i32> %shuf_0, <4 x i32> %K0
  %vadd_1 = vadd <4 x i32> %shuf_1, <4 x i32> %K0
  %sha1h_0 = sha1h i32 (extractelement <4 x i32> %buf, i64 0)
  %sha1c_0 = sha1c <4 x i32> %buf, i32 %sz, <4 x i32> %vadd_0
  %vadd_2 = vadd <4 x i32> %shuf_2, <4 x i32> %K0
  %sha1su0_0 = sha1su0 <4 x i32> %shuf_0, <4 x i32> %shuf_1, <4 x i32> %shuf_2
  %sha1h_1 = sha1h i32 (extractelement <4 x i32> %sha1c_0, i64 0)
  %sha1c_1 = sha1c <4 x i32> %sha1c_0, i32 %sha1h_0, <4 x i32> %vadd_1
  %vadd_3 = vadd <4 x i32> %shuf_3, <4 x i32> %K0
  ...
  %sha1c_2 = sha1c <4 x i32> %sha1c_1, i32 %sha1h_1, <4 x i32> %vadd_2
  %vadd_4 = vadd <4 x i32> %sha1su1_0, <4 x i32> %K0
  ...
  %sha1c_3 = sha1c <4 x i32> %sha1c_2, i32 %sha1h_2, <4 x i32> %vadd_3
  %vadd_5 = vadd <4 x i32> %sha1su1_1, <4 x i32> %K1
  ...
  %sha1c_4 = sha1c <4 x i32> %sha1c_3, i32 %sha1h_3, <4 x i32> %vadd_4
  %vadd_6 = vadd <4 x i32> %sha1su1_2, <4 x i32> %K1
  ...
  %sha1p_0 = sha1p <4 x i32> %sha1c_4, i32 %sha1h_4, <4 x i32> %vadd_5
  %vadd_7 = vadd <4 x i32> %sha1su1_3, <4 x i32> %K1
  ...
  %sha1p_1 = sha1p <4 x i32> %sha1p_0, i32 %sha1h_5, <4 x i32> %vadd_6
  %vadd_8 = vadd <4 x i32> %sha1su1_4, <4 x i32> %K1
  ...
  %sha1p_2 = sha1p <4 x i32> %sha1p_1, i32 %sha1h_6, <4 x i32> %vadd_7
  %vadd_9 = vadd <4 x i32> %sha1su1_5, <4 x i32> %K1
  ...
  %sha1p_3 = sha1p <4 x i32> %sha1p_2, i32 %sha1h_7, <4 x i32> %vadd_8
  %vadd_10 = vadd <4 x i32> %sha1su1_6, <4 x i32> %K2
  ...
  %sha1p_4 = sha1p <4 x i32> %sha1p_3, i32 %sha1h_8, <4 x i32> %vadd_9
  %vadd_11 = vadd <4 x i32> %sha1su1_7, <4 x i32> %K2
  ...
  %sha1m_0 = sha1m <4 x i32> %sha1p_4, i32 %sha1h_9, <4 x i32> %vadd_10
  %vadd_12 = vadd <4 x i32> %sha1su1_8, <4 x i32> %K2
  ...
  %sha1m_1 = sha1m <4 x i32> %sha1m_0, i32 %sha1h_10, <4 x i32> %vadd_11
  %vadd_13 = vadd <4 x i32> %sha1su1_9, <4 x i32> %K2
  ...
  %sha1m_2 = sha1m <4 x i32> %sha1m_1, i32 %sha1h_11, <4 x i32> %vadd_12
  %vadd_14 = vadd <4 x i32> %sha1su1_10, <4 x i32> %K2
  ...
  %sha1m_3 = sha1m <4 x i32> %sha1m_2, i32 %sha1h_12, <4 x i32> %vadd_13
  %vadd_15 = vadd <4 x i32> %sha1su1_11, <4 x i32> %K3
  ...
  %sha1m_4 = sha1m <4 x i32> %sha1m_3, i32 %sha1h_13, <4 x i32> %vadd_14
  %vadd_16 = vadd <4 x i32> %sha1su1_12, <4 x i32> %K3
  ...
  %sha1p_5 = sha1p <4 x i32> %sha1m_4, i32 %sha1h_14, <4 x i32> %vadd_15
  %vadd_17 = vadd <4 x i32> %sha1su1_13, <4 x i32> %K3
  ...
  %sha1p_6 = sha1p <4 x i32> %sha1p_5, i32 %sha1h_15, <4 x i32> %vadd_16
  %vadd_18 = vadd <4 x i32> %sha1su1_14, <4 x i32> %K3
  %sha1su1_15 = sha1su1 <4 x i32> %sha1su0_15, <4 x i32> %sha1su1_14
  %sha1h_17 = sha1h i32 (extractelement <4 x i32> %sha1p_6, i64 0)
  %sha1p_7 = sha1p <4 x i32> %sha1p_6, i32 %sha1h_16, <4 x i32> %vadd_17
  %vadd_19 = vadd <4 x i32> %sha1su1_15, <4 x i32> %K3
  %sha1h_18 = sha1h i32 (extractelement <4 x i32> %sha1p_7, i64 0)
  %sha1p_8 = sha1p <4 x i32> %sha1p_7, i32 %sha1h_17, <4 x i32> %vadd_18
  %sha1h_19 = sha1h i32 (extractelement <4 x i32> %sha1p_8, i64 0)
  %sha1p_9 = sha1p <4 x i32> %sha1p_8, i32 %sha1h_18, <4 x i32> %vadd_19
  %vadd_20 = vadd <4 x i32> %sha1p_9, %buf
  %add_0 = add i32 %sha1h_19, %sz
  %inselm_0 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %add_0, i64 0
  %insval_0 = insertvalue %struct.uint32x4x2_t poison, <4 x i32> %vadd_20, 0, 0
...
attributes #0 = { mustprogress nofree noinline norecurse nosync nounwind ssp willreturn memory(none) "frame-pointer"="non-leaf" "no-trapping-math"="true"
"stack-protector-buffer-size"="8" "target-cpu"="apple-a14"
"target-features"="+aes,+altnzcv,+ccdp,+ccidx,+complxnum,+crc,+dit,+dotprod,+flagm,+fp-armv8,+fp16fml,+fptoint,+fullfp16,+jsconv,+lse,+neon,+pauth,+perfmon,+predres,+ras,+rcpc
,+rdm,+sb,+sha2,+sha3,+specrestrict,+ssbs,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8a,+zcm,+zcz" }
