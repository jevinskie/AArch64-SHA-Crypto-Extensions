...
define %struct.uint32x4x2_t @sha1_arm_unrolled_compress_one(<4 x i32> %buf, i32 %sz, [4 x <4 x i32>] %blocks) local_unnamed_addr #0 {
  ...
  %13 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %9, <4 x i32> %19)
  ...
  %19 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %16, <4 x i32> %19, <4 x i32> %13)
  ...
  %24 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %19, <4 x i32> %13, <4 x i32> %18)
