...
define %struct.uint32x4x2_t @sha1_arm_unrolled_compress_one(<4 x i32> %buf, i32 %sz, [4 x <4 x i32>] %blocks) local_unnamed_addr #0 {
  ...
  %4 = add <4 x i32> %0, <4 x i32> %K0
  %5 = add <4 x i32> %1, <4 x i32> %K0
  %6 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %buf, i64 0))
  %7 = call <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %0, i32 %sz, <4 x i32> %4)
  %8 = add <4 x i32> %2, <4 x i32> %K0
  %9 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %10, <4 x i32> %13, <4 x i32> %16)
  %10 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %7, i64 0))
  %11 = call <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %7, i32 %6, <4 x i32> %5)
  %12 = add <4 x i32> %3, <4 x i32> %K0
  %13 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %9, <4 x i32> %3)
  %14 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %13, <4 x i32> %16, <4 x i32> %3)
  %15 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %11, i64 0))
  %16 = call <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %11, i32 %10, <4 x i32> %8)
  %17 = add <4 x i32> %13, <4 x i32> %K0
  %18 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %14, <4 x i32> %13)
  %19 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %16, <4 x i32> %3, <4 x i32> %13)
  %20 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %16, i64 0))
  %21 = call <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %16, i32 %15, <4 x i32> %12)
  %22 = add <4 x i32> %18, <4 x i32> %K1
  %23 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %19, <4 x i32> %18)
  %24 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %3, <4 x i32> %13, <4 x i32> %18)
  %25 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %21, i64 0))
  %26 = call <4 x i32> @llvm.aarch64.crypto.sha1c(<4 x i32> %21, i32 %20, <4 x i32> %17)
  %27 = add <4 x i32> %23, <4 x i32> %K1
  %28 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %24, <4 x i32> %23)
  %29 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %13, <4 x i32> %18, <4 x i32> %23)
  %30 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %26, i64 0))
  %31 = call <4 x i32> @llvm.aarch64.crypto.sha1p(<4 x i32> %26, i32 %25, <4 x i32> %22)
  %32 = add <4 x i32> %28, <4 x i32> %K1
  %33 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %29, <4 x i32> %28)
  %34 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %18, <4 x i32> %23, <4 x i32> %28)
  %35 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %31, i64 0))
  %36 = call <4 x i32> @llvm.aarch64.crypto.sha1p(<4 x i32> %31, i32 %30, <4 x i32> %27)
  %37 = add <4 x i32> %33, <4 x i32> %K1
  %38 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %34, <4 x i32> %33)
  %39 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %23, <4 x i32> %28, <4 x i32> %33)
  %40 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %36, i64 0))
  %41 = call <4 x i32> @llvm.aarch64.crypto.sha1p(<4 x i32> %36, i32 %35, <4 x i32> %32)
  %42 = add <4 x i32> %38, <4 x i32> %K1
  %43 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %39, <4 x i32> %38)
  %44 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %28, <4 x i32> %33, <4 x i32> %38)
  %45 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %41, i64 0))
  %46 = call <4 x i32> @llvm.aarch64.crypto.sha1p(<4 x i32> %41, i32 %40, <4 x i32> %37)
  %47 = add <4 x i32> %43, <4 x i32> %K2
  %48 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %44, <4 x i32> %43)
  %49 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %33, <4 x i32> %38, <4 x i32> %43)
  %50 = call i32 @llvm.aarch64.crypto.sha1h(i32 (extractelement <4 x i32> %46, i64 0))
  %51 = call <4 x i32> @llvm.aarch64.crypto.sha1p(<4 x i32> %46, i32 %45, <4 x i32> %42)
  %52 = add <4 x i32> %48, <4 x i32> %K2
  %53 = call <4 x i32> @llvm.aarch64.crypto.sha1su1(<4 x i32> %49, <4 x i32> %48)
  %54 = call <4 x i32> @llvm.aarch64.crypto.sha1su0(<4 x i32> %38, <4 x i32> %43, <4 x i32> %48)
